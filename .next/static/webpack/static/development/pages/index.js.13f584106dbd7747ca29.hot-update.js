...
function FeaturedCategories(props) {
  ...
  return __jsx("div", {
  ...
  }), categories.map(function (i, category) {
    return __jsx("div", {
      key: category.id,
      __self: _this,
      __source: {
    ...
    }, categories.length === i + 1 ? __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
      href: "!#",
    ...
    }, category.title)) : __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      className: "FeaturedCategories-Item",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.13f584106dbd7747ca29.hot-update.js.map